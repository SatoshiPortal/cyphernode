...
export SPENDING_ELEMENTS_NODE_RPC_URL
export SPENDING_ELEMENTS_NODE_RPC_CFG
export WATCHING_ELEMENTS_NODE_RPC_URL
export WATCHING_ELEMENTS_NODE_RPC_CFG
export TRACING
export DB_PATH
export DB_FILE
...
createCurlConfig ${SPENDING_ELEMENTS_NODE_RPC_CFG} ${SPENDING_ELEMENTS_NODE_RPC_USER}
createCurlConfig ${WATCHING_ELEMENTS_NODE_RPC_CFG} ${WATCHING_ELEMENTS_NODE_RPC_USER}
