...
manage_missed_conf() {
  ...
  received_watches=$(send_batch_to_bitcoin_node "${SPENDER_BTC_NODE_RPC_URL}/${SPENDER_BTC_NODE_DEFAULT_WALLET}" "${SPENDER_BTC_NODE_RPC_CFG}" "${body_file}")
  rm ${body_file}
