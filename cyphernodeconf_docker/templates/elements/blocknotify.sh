...
blocknotify(){
  ...
  echo "[blocknotify-$$] mosquitto_pub -h broker -t elements_newblock -m \"{\"blockhash\":\"${blockhash}\",\"blockheight\":${blockheight}}\""
  mosquitto_pub -h broker -t elements_newblock -m "{\"blockhash\":\"${blockhash}\",\"blockheight\":${blockheight}}"
  echo "[blocknotify-$$] mosquitto_pub -h broker -t elementsnode/newblock -m \"{\"blockhash\":\"${blockhash}\",\"blockheight\":${blockheight}}\""
  mosquitto_pub -h broker -t elementsnode/newblock -m "{\"blockhash\":\"${blockhash}\",\"blockheight\":${blockheight}}"
  ...
  echo "[blocknotify-$$] [chain_tip=$chain_tip]"
