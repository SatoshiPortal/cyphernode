...
const schema_0_1_0 = require('../schema/config-v0.1.0.json');
const schema_0_2_0 = require('../schema/config-v0.2.0.json');
const schema_0_2_2 = require('../schema/config-v0.2.2.json');
