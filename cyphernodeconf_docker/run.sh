...
export PROXYCRON_VERSION=v0.3.1-rc.1
export PYCOIN_VERSION=v0.3.1-rc.1
export SETUP_VERSION=v0.3.1-rc.1
export BITCOIN_VERSION=v0.19.0.1
export LIGHTNING_VERSION=v0.8.0
export DEFAULT_DATADIR_BASE=$HOME
export GATEKEEPER_VERSION=v0.3.1-rc.1
export TOR_VERSION=v0.3.1-rc.1
export PROXY_VERSION=v0.3.1-rc.1
export OTSCLIENT_VERSION=v0.3.1-rc.1
export NOTIFIER_VERSION=v0.3.1-rc.1
