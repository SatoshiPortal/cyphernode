...
export PROXYCRON_VERSION=v0.2.2-rc.1
export PYCOIN_VERSION=v0.2.2-rc.1
export SETUP_VERSION=v0.2.2-rc.1
export BITCOIN_VERSION=v0.17.1
export LIGHTNING_VERSION=v0.7.0
export DEFAULT_DATADIR_BASE=$HOME
export GATEKEEPER_VERSION=v0.2.2-rc.1
export PROXY_VERSION=v0.2.2-rc.1
export OTSCLIENT_VERSION=v0.2.2-rc.1
export NOTIFIER_VERSION=v0.2.2-rc.1
