...
export PROXYCRON_VERSION=v0.5.0-rc.1
export PYCOIN_VERSION=v0.5.0-rc.1
export SETUP_VERSION=v0.5.0-rc.1
export BITCOIN_VERSION=v0.20.1
export LIGHTNING_VERSION=v0.9.1
export DEFAULT_DATADIR_BASE=$HOME
export GATEKEEPER_VERSION=v0.5.0-rc.1
export TOR_VERSION=v0.5.0-rc.1
export PROXY_VERSION=v0.5.0-rc.1
export OTSCLIENT_VERSION=v0.5.0-rc.1
export NOTIFIER_VERSION=v0.5.0-rc.1
