...
export PROXYCRON_VERSION=v0.3.0-rc.2
export PYCOIN_VERSION=v0.3.0-rc.2
export SETUP_VERSION=v0.3.0-rc.2
export BITCOIN_VERSION=v0.19.0.1
export LIGHTNING_VERSION=v0.8.0
export DEFAULT_DATADIR_BASE=$HOME
export GATEKEEPER_VERSION=v0.3.0-rc.2
export TOR_VERSION=v0.3.0-rc.2
export PROXY_VERSION=v0.3.0-rc.2
export OTSCLIENT_VERSION=v0.3.0-rc.2
export NOTIFIER_VERSION=v0.3.0-rc.2
