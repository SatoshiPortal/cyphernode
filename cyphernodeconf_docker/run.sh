...
export PROXYCRON_VERSION=v0.2.4-rc.2
export PYCOIN_VERSION=v0.2.4-rc.2
export SETUP_VERSION=v0.2.4-rc.2
export BITCOIN_VERSION=v0.18.0
export LIGHTNING_VERSION=v0.7.1
export DEFAULT_DATADIR_BASE=$HOME
export GATEKEEPER_VERSION=v0.2.4-rc.2
export PROXY_VERSION=v0.2.4-rc.2
export OTSCLIENT_VERSION=v0.2.4-rc.2
export NOTIFIER_VERSION=v0.2.4-rc.2
