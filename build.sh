...
# CYPHERNODE VERSION "v0.2.2"
CONF_VERSION="v0.2.2-local"
GATEKEEPER_VERSION="v0.2.2-local"
PROXY_VERSION="v0.2.2-local"
NOTIFIER_VERSION="v0.2.2-local"
PROXYCRON_VERSION="v0.2.2-local"
OTSCLIENT_VERSION="v0.2.2-local"
PYCOIN_VERSION="v0.2.2-local"
BITCOIN_VERSION="v0.18.0"
LIGHTNING_VERSION="v0.7.1"
GRAFANA_VERSION="v0.2.2-local"
