...
# CYPHERNODE VERSION "v0.9.0-rc.3"
CONF_VERSION="v0.9.0-rc.3-local"
GATEKEEPER_VERSION="v0.9.0-rc.3-local"
TOR_VERSION="v0.9.0-rc.3-local"
PROXY_VERSION="v0.9.0-rc.3-local"
NOTIFIER_VERSION="v0.9.0-rc.3-local"
PROXYCRON_VERSION="v0.9.0-rc.3-local"
OTSCLIENT_VERSION="v0.9.0-rc.3-local"
PYCOIN_VERSION="v0.9.0-rc.3-local"
