...
# CYPHERNODE VERSION "v0.8.0-rc.2-dev" -> dev over v0.8.0-rc.2
CONF_VERSION="v0.8.0-rc.2-dev-local"
GATEKEEPER_VERSION="v0.8.0-rc.2-dev-local"
TOR_VERSION="v0.8.0-rc.2-dev-local"
PROXY_VERSION="v0.8.0-rc.2-dev-local"
NOTIFIER_VERSION="v0.8.0-rc.2-dev-local"
PROXYCRON_VERSION="v0.8.0-rc.2-dev-local"
OTSCLIENT_VERSION="v0.8.0-rc.2-dev-local"
PYCOIN_VERSION="v0.8.0-rc.2-dev-local"
