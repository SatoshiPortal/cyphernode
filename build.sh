...
# CYPHERNODE VERSION "v0.4.0-rc.2"
CONF_VERSION="v0.4.0-rc.2-local"
GATEKEEPER_VERSION="v0.4.0-rc.2-local"
TOR_VERSION="v0.4.0-rc.2-local"
PROXY_VERSION="v0.4.0-rc.2-local"
NOTIFIER_VERSION="v0.4.0-rc.2-local"
PROXYCRON_VERSION="v0.4.0-rc.2-local"
OTSCLIENT_VERSION="v0.4.0-rc.2-local"
PYCOIN_VERSION="v0.4.0-rc.2-local"
