...
# CYPHERNODE VERSION "v0.4.0-rc.1"
CONF_VERSION="v0.4.0-rc.1-local"
GATEKEEPER_VERSION="v0.4.0-rc.1-local"
TOR_VERSION="v0.4.0-rc.1-local"
PROXY_VERSION="v0.4.0-rc.1-local"
NOTIFIER_VERSION="v0.4.0-rc.1-local"
PROXYCRON_VERSION="v0.4.0-rc.1-local"
OTSCLIENT_VERSION="v0.4.0-rc.1-local"
PYCOIN_VERSION="v0.4.0-rc.1-local"
