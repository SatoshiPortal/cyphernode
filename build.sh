...
# CYPHERNODE VERSION "v0.8.0-rc.1-dev" -> dev over v0.8.0-rc.1
CONF_VERSION="v0.8.0-rc.1-dev-local"
GATEKEEPER_VERSION="v0.8.0-rc.1-dev-local"
TOR_VERSION="v0.8.0-rc.1-dev-local"
PROXY_VERSION="v0.8.0-rc.1-dev-local"
NOTIFIER_VERSION="v0.8.0-rc.1-dev-local"
PROXYCRON_VERSION="v0.8.0-rc.1-dev-local"
OTSCLIENT_VERSION="v0.8.0-rc.1-dev-local"
PYCOIN_VERSION="v0.8.0-rc.1-dev-local"
