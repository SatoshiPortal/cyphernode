...
install_docker() {
  ...
  if [[ $BITCOIN_INTERNAL == true ]]; then
    ...
    copy_file $cyphernodeconf_filepath/bitcoin/blocknotify.sh $BITCOIN_DATAPATH/blocknotify.sh 1 $SUDO_REQUIRED
...
# CYPHERNODE VERSION "v0.9.0-rc.1"
SETUP_VERSION="v0.9.0-rc.1"
CONF_VERSION="v0.9.0-rc.1"
GATEKEEPER_VERSION="v0.9.0-rc.1"
TOR_VERSION="v0.9.0-rc.1"
PROXY_VERSION="v0.9.0-rc.1"
NOTIFIER_VERSION="v0.9.0-rc.1"
PROXYCRON_VERSION="v0.9.0-rc.1"
OTSCLIENT_VERSION="v0.9.0-rc.1"
PYCOIN_VERSION="v0.9.0-rc.1"
